...
int main(int argc, char *argv[])
{
  ...
  if(argc!=4)
    {
      printf("TigressCsIArray_ECalABSuppCsIRingSum master_file_name supLow supHigh\n");
      exit(-1);
    }
  
  printf("Program sorts ECalABSuppCsIRingSum histograms for TIGRESS.\n");
  ...
  if((output=fopen("CsIRing_ECalABSuppSum.mca","w"))==NULL)
    {
