...
int main(int argc, char *argv[])
{
  ...
  h = new TH2D("Tigress Csiarray Time","Tigress Csiarray Time",S4K,0,S4K-1,S4K,0,S4K-1);
  h->Reset();
  ...
  canvas = new TCanvas("TTCalLim", "TTCalLim",10,10, 500, 300);
  gPad->SetLogz(1);
  gStyle->SetPalette(1);
  h->Draw("COLZ");
