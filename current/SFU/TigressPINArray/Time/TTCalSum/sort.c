//Program sorts a 2-D histogram of Tigress and PIN time
...
int main(int argc, char *argv[])
{
  ...
  //set the bin size and limits here
  h = new TH2D(title,title,8000,19000,20700,8000,15000,23500);
  h->Reset();

  sprintf(title,"Tigress_Time_minus_PINArray_Time");
  h1 = new TH1D(title,title,S4K,0,5000);
  h1->Reset();
