...
int main(int argc, char *argv[])
{
 ...
 if(argc!=8)
    {
      printf("\n ./wfit_chisq_lin_two_components midas_input_data_file_name channel trc tf ts tp trf\n");
      exit(-1);
    }
  ...
  h=new TH1D("chisq","chisq",S16K,-4,S16K-4);
  h->Reset();
...
/* do sorting */
 ...
 /* display results */
  ...
  fwrite(hist,S32K*sizeof(int),3,output);
