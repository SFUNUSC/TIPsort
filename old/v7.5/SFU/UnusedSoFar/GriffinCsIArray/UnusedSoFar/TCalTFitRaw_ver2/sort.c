...
int main(int argc, char *argv[])
{
  ...
  if(argc!=6)
    {
      printf("Griffin_CsIArray_TCalTRawFit master_file_name idmin idmax chimin chimax\n");
      exit(-1);
    }
  ...
  printf("Program sorts calibrated 2D histogram for GRIFFIN_TCal and CsIArray_TRawFit timing.\n");
