...
MainWindow::MainWindow(int width, int height)	
	...
	fLabel2 = new TGLabel(fLabelFrame1 ,"no histograms read                                                                                  ");
	...
	fLabel6 = new TGLabel(fLabelFrame2,"no file selected                                                                                     ");
	...
	fLabel4 = new TGLabel(fLabelFrame3,"no gates saved                                                                                       ");
	...
	fLabelFrame->AddFrame(fLabelFrame1,new TGLayoutHints(kLHintsExpandY));
	fLabelFrame->AddFrame(fLabelFrame2,new TGLayoutHints(kLHintsExpandY));
	fLabelFrame->AddFrame(fLabelFrame3,new TGLayoutHints(kLHintsExpandY));
