...
int main(int argc, char *argv[])
{
  ...
  if(argc!=4)
    {
      printf("Tigress_ECalABSuppRing_2SuppGammas master_file_name supLow supHigh\n");
      printf("Program sorts ECalABSuppRing histograms for TIGRESS.\nThis code is meant to emulate a 2 suppressed gamma trigger, only letting through events with at least 2 gammas of appropriate energy following suppression.\n");
      exit(-1);
    }
