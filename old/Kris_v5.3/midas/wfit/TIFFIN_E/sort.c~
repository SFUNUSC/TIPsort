...
int main(int argc, char *argv[])
{
  ...
  h=new TH1D("Energy","Energy;Energy (DAQ Units);Counts",S8K,0,S32K);
  h->Reset();  
  ...
  er=new TH2D("Energy against Risetime","E/T;Energy (DAQ Units); Risetime (10 ns Samples)",S4K,0,S4K,S1K,0,S1K);
  er->Reset();
