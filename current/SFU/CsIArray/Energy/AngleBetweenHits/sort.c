...
int main(int argc, char *argv[])
{
  ...
  positionHist = new TH1D("AngleHistogramFromPositions","AngleHistogramFromPositions",360,0,360);
  positionHist->Reset();
  h = new TH1D("AngleHistogramFromData","AngleHistogramFromData",360,0,360);
  h->Reset();
