...
int main(int argc, char *argv[])
{
  ...
  printf("Program sorts summed TCal histograms for Tigress crystal cores from a cluster file for events within specified time limits.\n");
