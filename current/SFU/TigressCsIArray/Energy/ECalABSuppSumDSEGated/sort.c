...
int main(int argc, char *argv[])
{
  ...
  if((argc!=6)&&(argc!=7))
    {
      printf("TigressCsIArray_ECalABSuppSumDSEGated master_file_name supLow supHigh gateELow gateEHigh fudge_factor\n");
  ...
  sprintf(FileName,"ECalABSuppSumDS_c%.0f_w%.0fgated.mca",avgGateE,gateWidth);
  ...
  sprintf(FileName,"ECalABSuppSumDS_c%.0f_w%.0fgate.mca",avgGateE,gateWidth);
  if((output=fopen(FileName,"w"))==NULL)
    {
      printf("ERROR!!! I cannot open the mca file!\n");
      exit(EXIT_FAILURE);
  ...
  sprintf(FileName,"ECalABSuppSumDS_c%.0f_w%.0fproj.mca",avgGateE,gateWidth);
  if((output=fopen(FileName,"w"))==NULL)
    {
      printf("ERROR!!! I cannot open the mca file!\n");
      exit(EXIT_FAILURE);
